...
export const ICON_PATHS = {
  ...
  // picture-in-picture: window with a small inner window, bottom-right
  pip: "M1.75 2A1.75 1.75 0 0 0 0 3.75v8.5C0 13.22.78 14 1.75 14H6v-1.5H1.75a.25.25 0 0 1-.25-.25v-8.5a.25.25 0 0 1 .25-.25h12.5a.25.25 0 0 1 .25.25V7H16V3.75A1.75 1.75 0 0 0 14.25 2H1.75ZM8.75 9A.75.75 0 0 0 8 9.75v4.5c0 .41.34.75.75.75h6.5a.75.75 0 0 0 .75-.75v-4.5a.75.75 0 0 0-.75-.75h-6.5Z",
